...
class MushroomTemplate:
    ...
    def get_pathfinding_costs(self, tile_position):
        return [(abs(self.position[0] - tile_position[0]) + abs(self.position[1] - tile_position[1])), (abs(tile_position[0] - self.target_position[0]) + abs(tile_position[1] - self.target_position[1]))]
